...
Use python 3.11.2 for this project
...
PD: The code has a hugging face token, I forgot to delete it so it has been deactivated, the token in the code doesn't work
